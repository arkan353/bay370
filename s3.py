# Оказывается, что если не провеодить всю свою карьеру в IT в НИИ вычилслительной техники имени Адольфа Алоизовича Печкина то можно начать уметь пользоваться s3 и git
import logging
import os
import dotenv
import requests
